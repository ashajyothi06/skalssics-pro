...
//   const domains = [
//     { name: "sklassics.com", icon: Globe, color: "yellow", path: "/" },
//     { name: "sklassicstech.com", icon: Code, color: "blue", path: "/tech" },
//     { name: "sklassicsacademy.com", icon: BookOpen, color: "purple", path: "/ItTraining" },
//     { name: "sklassics-lms.com", icon: Target, color: "cyan", path: "/LMS" },
//     { name: "sklassics-ai.com", icon: Zap, color: "pink", path: "/AiInterview" },
//     { name: "sklassicstutor.com", icon: Users, color: "green", path: "/Tutors" },
//     { name: "sklassics-quiz.com", icon: Star, color: "yellow", path: "/QuizApp" },
//     { name: "hanumancars.com", icon: Car, color: "blue", path: "/HanumanCars" },
//     { name: "vlrws.com", icon: Building, color: "purple", path: "/RealEstate" },
//   ];
...
//   // Function to handle external domain navigation
//   const handleDomainClick = (domain) => {
//     // For demo purposes, we'll use internal navigation
//     // In production, you might want to use window.location.href = `https://${domain}`
//     const matchingDomain = domains.find(d => d.name === domain);
//     if (matchingDomain) {
//       navigate(matchingDomain.path);
//     }
//   };
...
//                 <motion.div
//                   key={service.name}
//                   className="group flex items-center gap-3 p-4 rounded-xl bg-dark-800/30 backdrop-blur-sm border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:shadow-glow-purple cursor-pointer"
//                   initial={{ opacity: 0, x: -30 }}
//                   animate={isVisible ? { opacity: 1, x: 0 } : {}}
//                   transition={{ duration: 0.5, delay: 0.8 + index * 0.1 }}
//                   whileHover={{ 
...
//                       {service.name}
//                     </span>
//                     <span className="text-xs text-gray-400">{service.website}</span>
//                   </div>
//                   <motion.div
//                     className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity"
//                     whileHover={{ x: 3 }}
...
//                 <motion.div
//                   key={domain.name}
//                   className="group flex items-center gap-3 p-4 rounded-xl bg-dark-800/30 backdrop-blur-sm border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:shadow-glow-purple cursor-pointer"
//                   initial={{ opacity: 0, y: 30 }}
//                   animate={isVisible ? { opacity: 1, y: 0 } : {}}
//                   transition={{ duration: 0.5, delay: 1 + index * 0.1 }}
//                   whileHover={{ 
...
//             <motion.div 
//               className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-full font-semibold shadow-glow-purple cursor-pointer"
//               initial={{ opacity: 0, scale: 0.8 }}
//               animate={isVisible ? { opacity: 1, scale: 1 } : {}}
//               transition={{ duration: 0.5, delay: 2.2 }}
//               whileHover={{ 
...
//                 boxShadow: "0 0 30px rgba(168, 85, 247, 0.6)",
//               }}
//               onClick={() => window.location.href = "tel:+919392732341"}
//             >
//               +91 9392732341
//             </motion.div>
